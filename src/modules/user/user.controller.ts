...
import { UserChangePasswordFromForgotPasswordRequestDTO, UserChangePasswordRequestDTO, UserForgotPasswordRequestDTO, UserLoginRequestDTO, UserRegisterRequestDTO } from "./user.request.dto";
...
export class UserController {
  ...
  change_password(@User_Id() _id: string, @Body() body: UserChangePasswordRequestDTO) {
  ...
  change_password_from_forgot(@Body() body: UserChangePasswordFromForgotPasswordRequestDTO) {
