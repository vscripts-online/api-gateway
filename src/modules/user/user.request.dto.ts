import { IsAscii, IsEmail, IsOptional, IsString, IsStrongPassword, Length, Min, MinLength } from "class-validator";
...
export class UserChangePasswordRequestDTO {
  ...
  @IsNotEqualWith('current_password', { message: 'New password can not be equal with current password' })
  @IsStrongPassword({
    minLength: 8,
    minLowercase: 1,
    minNumbers: 1,
