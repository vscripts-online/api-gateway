...
import { AccountRepository, IAccountSchema, IFilePartSchema } from "src/database";
...
export abstract class BaseDrive {
  ...
  abstract get_storage_sizes(): Promise<Pick<IAccountSchema, 'storage_size' | 'available_size'>>
